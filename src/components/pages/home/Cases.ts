...
export const cases: ({ type: "site" | "bot" | "seo" | "app" } & CaseType)[] = [
  {
    ...
    tasks: ["Дизайн лендинга", "Копирайтинг (тексты)", "Вёрстка лендинга", "Сбор статистики и лидов"],
  ...
  },
  {
    ...
    tasks: ["Дизайн лендинга", "Копирайтинг (тексты)", "Вёрстка лендинга", "Установка метрик для сбора статистики", "Сбор лидов"],
  ...
  },
  {
    ...
    tasks: ["Дизайн лендинга", "Копирайтинг (тексты)", "Вёрстка лендинга", "Установка метрик для сбора статистики"],
  ...
  },
  {
    ...
    tasks: ["Дизайн лендинга", "Копирайтинг (тексты)", "Вёрстка лендинга", "Установка метрик и сбор статистики", "Отслеживание конверсии по продажам билетов"],
  ...
  },
  {
    ...
    tasks: ["Дизайн лендинга", "Копирайтинг (тексты)", "Вёрстка лендинга", "Установка метрик и сбор статистики", "Отслеживание регистраций"],
  ...
  },
  {
    ...
    tasks: ["Дизайн лендинга", "Копирайтинг (тексты)", "Вёрстка лендинга", "Установка метрик и сбор статистики", "Кастомизация системы управления сайтом"],
  ...
  },
  {
    ...
    tasks: ["Разработка дизайна сайта", "Копирайтинг (тексты)", "Вёрстка и программинг", "Кастомизация системы управления сайтом"],
  ...
  },
  {
    ...
    tasks: ["Разработка концепции проекта", "Разработка дизайна", "Введение нового функционала", "Вёрстка и программинг", "Кастомизация системы управления сайтом"],
  ...
  },
  {
    ...
    tasks: ["Разработка концепции проекта", "Копирайтинг (тексты)", "Вёрстка и программинг сайта", "Интеграция сайта с CRM системой", "Интеграция с сервисом складского учёта «Мой склад»", "Интеграция модуля ЛК и корзины", "Добавление виджета доставки заказа и онлайн-оплатой", "Кастомизация системы управления сайтом"],
  ...
  },
  {
    ...
    tasks: ["Разработка концепции проекта", "Копирайтинг (тексты)", "Вёрстка и программинг сайта", "Интеграция сайта с CRM системой", "Кастомизация системы управления сайтом", "Сбор лидов"],
    link: "https://mvk.ru"
  },
  {
    type: "site",
    ...
    tasks: ["Разработка дизайна сайта", "Копирайтинг (тексты)", "Вёрстка и программинг сайта", "Интеграция сайта с CRM системой", "Кастомизация системы управления сайтом"],
    link: "https://nmk.ru"
  },
  {
    type: "site",
    ...
    tasks: ["Разработка дизайна сайта", "Копирайтинг (тексты)", "Вёрстка и программинг сайта", "Интеграция сайта с CRM системой", "Кастомизация системы управления сайтом", "Интеграция с сервисом складского учета «Мой склад»", "Интеграция модуля ЛК и корзины", "Добавление виджета доставки заказа и онлайн-оплатой"],
  ...
  },
  {
    ...
    tasks: ["Полная переработка прохождения заказа и корзины в соответствии с бизнес-процессами заказчика.", "Исправление текущих ошибок предыдущего разработчика."],
