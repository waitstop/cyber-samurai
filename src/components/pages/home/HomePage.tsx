            ...
            <div className={"container py-8"}>
              ...
              <TabsContent value={"bot"}>
                <WhatWeCan
                  title={"Бот"}
                  description={
                    "Мы создаем уникальных для каждого заказчика Telegram-ботов, включая постоянную техническую поддержку их..."
                  }
                  subTasks={[
                  ...
                  tasks={[
                    ...
                    "Разработка и интеграция: создание, добавление программного кода для бота, интеграция с API Telegram, настройка базы данных и хранение информации.",
                    "Тестирование и отладка.",
