...
const HomePage = () => {
  return (
    <MainLayout className={"bg-violet-accent pt-14 text-white"}>
      {/*Hero page*/}
      ...
      <section className={"bg-zinc-800 pt-10"}>
        ...
        <Tabs defaultValue={"site"}>
          <TabsList className={"container py-10"}>
            ...
            <TabsTrigger
              disabled={
                cases.filter((casesItem) => casesItem.type === "app").length ===
                0
              }
              className={"group relative"}
              value={"app"}
            ...
            <TabsTrigger
              disabled={
                cases.filter((casesItem) => casesItem.type === "bot").length ===
                0
              }
              className={"group relative"}
              value={"bot"}
            ...
            <TabsTrigger
              disabled={
                cases.filter((casesItem) => casesItem.type === "seo").length ===
                0
              }
              className={"group relative"}
              value={"seo"}
          ...
          <TabsContent
            className={"container m-0 h-auto bg-black py-8"}
            value={"site"}
          >
            <CasesCarousel
              navigation
      ...
      <section className={"container bg-zinc-800 pt-10"}>
        <ContactForm />
      </section>
      <section className={"container bg-red-500 py-10"}>
        ...
        <h2 className={"mt-5 font-inter text-lg font-medium leading-normal"}>
          Кода клиент приходит к нам со своими болями, мы, как заправский врач,
          подбираем наиболее подходящий инструмент для их решений. А вот и
          некоторые примеры!
        </h2>
            ...
            <SwiperSlide className={"rounded-xl bg-white p-3"}>
              <div className={"grid grid-cols-2 gap-x-2"}>
                <div>
                  ...
                  <p className={"text-xs font-medium text-black/40"}>{pain}</p>
                </div>
                <div>
                  <span
                    className={
      ...
      <section className={"clients container bg-black py-10 text-white"}>
